...
export async function renderApp() {
  init({
    name: "host-runtime",
    remotes: [{ name: "@provider", entry: "http://localhost:3001/mf-manifest.json", alias: "pro" }],
    plugins: [runtimePlugin()],
  });

  loadRemote("pro/const").then((module) => {
    console.log("results from const in provider: ", (module as any).default());
  });
